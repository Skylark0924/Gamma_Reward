...
def summarize_episodes(episodes, new_episodes):
    ...
    for episode in episodes:
        ...
        episode_rewards.append(episode.episode_reward/episode.episode_length)
        ...
        for (_, policy_id), reward in episode.agent_rewards.items():
            if policy_id != DEFAULT_POLICY_ID:
                '''For Average Episode Reward'''
                policy_rewards[policy_id].append(reward/episode.episode_length)
                # --------------------------------------------
    if episode_rewards:
