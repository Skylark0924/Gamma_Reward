...
from Override_ray.metrics import collect_metrics
from ray.rllib.optimizers.policy_optimizer import PolicyOptimizer
from Override_ray.worker_set import WorkerSet
from ray.rllib.utils.annotations import override, PublicAPI, DeveloperAPI
from ray.rllib.utils import FilterManager, deep_update, merge_dicts
from ray.rllib.utils.memory import ray_get_and_free
from ray.rllib.utils import try_import_tf
from ray.tune.registry import ENV_CREATOR, register_env, _global_registry
from Override_ray.trainable import Trainable
...
class Trainer(Trainable):
    ...
    @override(Trainable)
    @PublicAPI
    def train(self, attention_score_dic=None):
        ...
        for _ in range(1 + MAX_WORKER_FAILURE_RETRIES):
            try:
                result = Trainable.train(self, attention_score_dic)
