...
parser.add_argument('--config', type=str,
                    default='/home/skylark/PycharmRemote/Gamma-Reward-Perfect/config/global_config.json',
                    help='config file')
...
parser.add_argument('--num_step', type=int, default=360, help='number of timesteps for one episode, and for inference')
...
parser.add_argument('--project_name', type=str, default='1120_QMIX_1_6', help='Name of Project')
parser.add_argument('--Gamma_Reward', dest='Gamma_Reward', action='store_true')
parser.add_argument('--no-Gamma_Reward', dest='Gamma_Reward', action='store_false')
parser.set_defaults(Gamma_Reward=False)
